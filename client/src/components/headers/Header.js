...
function Header() {
    ...
    return (
        <header>
            ...
            <div className="logo">
                <h1>
                    <Link to="/">{isAdmin ? 'Admin' : 'Papers'}</Link>
                </h1>
            </div>
            ...
            <ul style={styleMenu}>
                ...
                {
                    isLogged ? loggedRouter() : <li><Link to="/login" className='login'>Login - Registrarse</Link></li>
                }
...

            {
                ...
                :<div className="cart-icon">
                    ...
                    <Link to="/cart">
                        <img src={Cart} alt="" width="30" className="icon" />
                    </Link>
                </div>
            }
